...
public:
    ...
    void cloudHandler::cloudCB_targ(const sensor_msgs::PointCloud2 &input)
    {
    ...
    void cloudHandler::cloudCB_scan(const sensor_msgs::PointCloud2 &input)
    {
...
main(int argc, char **argv)
{
    ...
    coords_pub = nh.advertise<relocalisation::updated_coord>("updated_coord",1);
